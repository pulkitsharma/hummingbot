...
from hummingbot.strategy.candle_spike import (
    CandleSpikeStrategy,
    OrderBookAssetPriceDelegate,
    APIAssetPriceDelegate
)
from hummingbot.strategy.candle_spike.candle_spike_config_map import candle_spike_config_map as c_map
...
def start(self):
    try:
        ...
        strategy_logging_options = CandleSpikeStrategy.OPTION_LOG_ALL

        self.strategy = CandleSpikeStrategy(
